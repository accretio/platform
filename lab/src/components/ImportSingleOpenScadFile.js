...
export default class ImportSingleOpenScadFile extends React.Component {
  ...
  render() {
    ...
    if (this.state.singleOpenScadFile) {
      descriptionPicker = <textarea onChange={this.onDescriptionChange.bind(this)} placeholder="Object description" />
    } else {
      descriptionPicker = ''
    }
    ...
    let argPicker = null
    if (this.state.singleOpenScadFile && this.state.description && this.state.description != '') {
